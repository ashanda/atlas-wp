...
if ( ! function_exists( 'atlas_posted_on' ) ) :
	...
	function atlas_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'atlas' ),
...
if ( ! function_exists( 'atlas_posted_by' ) ) :
	...
	function atlas_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'atlas' ),
	...
	function atlas_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'atlas' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'atlas' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
...
if ( ! function_exists( 'atlas_post_thumbnail' ) ) :
	/**
